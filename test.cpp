...
float x_pos = 22.0; float x_normal_pos = 22.0;
float y_pos = 100.0; float y_normal_pos = 100.0;
float z_pos = 90.0; float z_normal_pos = 90.0;
...
void keyBoardSpecail(unsigned char key, int x, int y)
{
	if (key == 'C') { 
		...
		if (x_pos == 40. && y_pos == 17. && z_pos == -44. && trainViewFlag == 0) {
			x_pos = -40;
			y_pos = 36;
			z_pos = -187;
			look_x = 50.;
		...
		else if (x_pos == -40. && y_pos == 36. && z_pos == -187. && trainViewFlag == 0) {
			trainViewFlag = 1;			
		}
...
//	glBegin(GL_QUADS);
//	glNormal3f(0.0, 0.0, 1.0);
//	glTexCoord2f(0., 0.); glVertex3f(-200, 0, -125);
//	glTexCoord2f(1., 0.); glVertex3f(200, 0, -125);
//	glTexCoord2f(1., 1.); glVertex3f(200, 300, -125);
//	glTexCoord2f(0., 1.); glVertex3f(-200, 300, -125);
//	glEnd();
//}
//
//void floor(){
...
//	glBegin(GL_QUADS);
//	glNormal3f(0.0, 1.0, 0.0);
//	glTexCoord2f(0., 0.); glVertex3f(-200, 0.1, -125);
//	glTexCoord2f(7., 0.); glVertex3f(200, 0.1, -125);
//	glTexCoord2f(7., 5.); glVertex3f(200, 0.1, 125);
//	glTexCoord2f(0., 5.); glVertex3f(-200, 0.1, 125);
//	glEnd();
//}
...
void aSleeper(float p1[2], float p2[2], float s1, float s2) {
	...
	glBegin(GL_QUADS);
	glNormal3f(0., 1., 0.);
	glVertex3f(e1[0], 0.1, e1[1]);  
	glVertex3f(e2[0], 0.1, e2[1]);
	glVertex3f(f2[0], 0.1, f2[1]);
	glVertex3f(f1[0], 0.1, f1[1]);
	glEnd();
}
...
void stationSupportBeam(float x, float y, float z) {
	glColor4f(1.0f, 0.5f, 0.0f, 0.5f);//orange/brown
	glPushMatrix();
	glScalef(x, y, z);
	glutSolidCube(1.0);
	glPopMatrix();
...
void stationSign() {
	...
	glBegin(GL_QUADS);
	glNormal3f(0.0, 0.0, 1.0);
	glTexCoord2f(0., 0.); glVertex3f(-5.0, 1.0, 0.);
	glTexCoord2f(1., 0.); glVertex3f(5.0, 1.0, 0.);
	glTexCoord2f(1., 1.); glVertex3f(5.0, 5.0, 0.);
	glTexCoord2f(0., 1.); glVertex3f(-5.0, 5.0, 0.);
	glEnd();
	glPopMatrix();*/
}
...
void station()
{
	...
	float y3 = convertToOneDecimalFloat(static_cast<float>(212) / 256);
	float x = convertToOneDecimalFloat(static_cast<float>(103) / 256);*/
	glColor4f(1.0f, 0.5f, 0.0f, 0.55f);//brown 
	...
	glColor4f(1.0f, 0.5f, 0.0f, 0.1f);//orange
	//glNormal3f(0.0, 0.0, 1.0);   //Facing +z (Front side)
	////glTexCoord2f(0.148, 0.); 
	//glVertex3f(-20.0, -15.0, 10);
	////glTexCoord2f(0.499, 0.); 
...
void display(void)
{
	...
	float lgt1_pos[] = { 0.0f, 30.0f, 0.0f, 1.0f };  //light0 position (directly above the origin) Omni-directional point sources
